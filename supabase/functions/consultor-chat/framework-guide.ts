...
`;
  ...
  async markEvent(conversationId: string, event: string, metadata?: any): Promise<void> {
    ...
    const eventMap: Record<string, any> = {
      ...
      'anamnese_solicitada': { anamnese_solicitada: true },
      'anamnese_exibida': { anamnese_formulario_exibido: true, anamnese_solicitada: true },
      ...
      'canvas_solicitado': { canvas_solicitado: true },
      'canvas_exibido': { canvas_formulario_exibido: true, canvas_solicitado: true },
      ...
      'cadeia_valor_solicitada': { cadeia_valor_solicitada: true },
      'cadeia_valor_exibida': { cadeia_valor_formulario_exibida: true, cadeia_valor_solicitada: true },
      ...
      'matriz_solicitada': { matriz_priorizacao_solicitada: true },
      'matriz_exibida': { matriz_priorizacao_formulario_exibido: true },
      'matriz_gerada': { matriz_priorizacao_preenchida: true, matriz_priorizacao_ts: new Date().toISOString(), aguardando_validacao_escopo: true, fase_atual: 'modelagem' },
      'escopo_validado': { escopo_validado_pelo_usuario: true, escopo_priorizacao_definido: true, escopo_validacao_ts: new Date().toISOString(), aguardando_validacao_escopo: false, fase_atual: 'execucao' },
